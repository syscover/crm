...
class CustomerController extends Controller
{
    ...
    protected $indexColumns = ['id_301', 'company_301', 'name_301', 'surname_301', ['data' => 'email_301', 'type' => 'email'], 'name_300', ['data' => 'active_301', 'type' => 'active'], ['data' => 'confirmed_301', 'type' => 'active']];
    ...
    public function storeCustomRecord($parameters)
    {
        $customer = Customer::create([
            ...
            'birth_date_301'            => $this->request->input('birthDate')? \DateTime::createFromFormat(config('pulsar.datePattern'), $this->request->input('birthDate'))->getTimestamp() : null,
        ...
        AttachmentLibrary::storeAttachments($attachments, 'crm', 'crm-customer', $customer->id_301, base_lang2()->id_001);
    }
    ...
    public function editCustomRecord($parameters)
    {
        ...
        $attachments = AttachmentLibrary::getRecords('crm', 'crm-customer', $parameters['object']->id_301, base_lang2()->id_001);
