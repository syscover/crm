...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    */
    ...
    Route::get(config('pulsar.appName') . '/crm/customers/create/{offset}/{tab}',              ['as'=>'createCrmCustomer',             'uses'=>'Syscover\Crm\Controllers\CustomerController@createRecord',               'resource' => 'crm-customer',        'action' => 'create']);
    Route::post(config('pulsar.appName') . '/crm/customers/store/{offset}/{tab}',              ['as'=>'storeCrmCustomer',              'uses'=>'Syscover\Crm\Controllers\CustomerController@storeRecord',                'resource' => 'crm-customer',        'action' => 'create']);
