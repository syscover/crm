...
Route::group(['middleware' => ['web', 'pulsar']], function() {
    ...
    |--------------------------------------------------------------------------
    */
    Route::any(config('pulsar.appName') . '/crm/customers/{modal}/{offset?}',                   ['as' => 'crmCustomer',                   'uses' => 'Syscover\Crm\Controllers\CustomerController@index',                      'resource' => 'crm-customer',        'action' => 'access']);
    ...
    Route::get(config('pulsar.appName') . '/crm/customers/{id}/edit/{offset}/{tab}/{modal}',    ['as' => 'editCrmCustomer',               'uses' => 'Syscover\Crm\Controllers\CustomerController@editRecord',                 'resource' => 'crm-customer',        'action' => 'access']);
    Route::put(config('pulsar.appName') . '/crm/customers/update/{id}/{offset}/{tab}/{modal}',  ['as' => 'updateCrmCustomer',             'uses' => 'Syscover\Crm\Controllers\CustomerController@updateRecord',               'resource' => 'crm-customer',        'action' => 'edit']);
    Route::get(config('pulsar.appName') . '/crm/customers/delete/{id}/{offset}/{modal}',        ['as' => 'deleteCrmCustomer',             'uses' => 'Syscover\Crm\Controllers\CustomerController@deleteRecord',               'resource' => 'crm-customer',        'action' => 'delete']);
    Route::delete(config('pulsar.appName') . '/crm/customers/delete/select/records/{modal}',    ['as' => 'deleteSelectCrmCustomer',       'uses' => 'Syscover\Crm\Controllers\CustomerController@deleteRecordsSelect',        'resource' => 'crm-customer',        'action' => 'delete']);
